 ...
 * 
 */
@WebServiceClient(name = "EstoqueWSService", targetNamespace = "http://ws.estoque.caelum.com.br/estoquews/v2", wsdlLocation = "http://localhost:8080/fj36-webservice/EstoqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ESTOQUEWSSERVICE_QNAME = new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "EstoqueWSService");
    ...
    public EstoqueWS getEstoqueWSPort() {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "EstoqueWSPort"), EstoqueWS.class);
    }
    ...
    public EstoqueWS getEstoqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "EstoqueWSPort"), EstoqueWS.class, features);
    }
