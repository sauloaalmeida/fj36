...
public class ObjectFactory {
    ...
    private final static QName _Token_QNAME = new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "token");
    private final static QName _ItensPeloCodigoResponse_QNAME = new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "ItensPeloCodigoResponse");
    private final static QName _ItensPeloCodigo_QNAME = new QName("http://ws.estoque.caelum.com.br/estoquews/v2", "ItensPeloCodigo");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.estoque.caelum.com.br/estoquews/v2", name = "token")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.estoque.caelum.com.br/estoquews/v2", name = "ItensPeloCodigoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.estoque.caelum.com.br/estoquews/v2", name = "ItensPeloCodigo")
